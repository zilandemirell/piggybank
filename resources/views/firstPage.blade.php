...
<div class="container" align="center">
    ...
    <h3 style="color:white; font-weight:bold;" >This website is the belong to the Smart Piggy Bank and used for viewing transactions in the bank.</p>
    <h3 style="color:white; font-weight:bold;" >You need to login or register to use the website.</p>
